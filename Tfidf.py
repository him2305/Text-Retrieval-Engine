...
#This program retrieves the relevant documents on the basis of query entered by a user.
...
#Count the occurence of a word present in the list of indexed documents.
...
#Reading the list of files and indexing them to a dictionary.
